...
import { 
  ...
  Briefcase, Building2, Calendar, User, Code, Sparkles, Heart, X
} from "lucide-react";
    ...
    <>
      <section className="max-w-4xl mx-auto px-4 pb-16">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white dark:bg-gray-900 md:rounded-2xl rounded-md p-6 md:p-10 border border-gray-100 dark:border-gray-800 shadow-sm"
        >
          {/* Author Header */}
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-10">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-gray-500 dark:text-gray-400 font-medium mb-4">
                {staff.designation} <span className="mx-2 text-gray-300 dark:text-gray-600">|</span>
                {staff.department}
              </p>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                ...
                {staff.email && (
                  <button
                    ...
                    className="inline-flex items-center gap-2 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 transition-colors bg-gray-50 dark:bg-gray-800 px-3 py-1.5 rounded-lg border border-gray-100 dark:border-gray-700"
                  >
                ...
                <a href={shareUrls.facebook} target="_blank" rel="noopener noreferrer"
                  className="p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 rounded-xl hover:border-blue-600 hover:text-blue-600 transition-all">
          ...
          {authorStats.length > 0 && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-gray-100 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl overflow-hidden mb-10">
              {authorStats.map((stat, index) => (
                <div key={index} className="bg-white dark:bg-gray-900 p-4 flex flex-col items-center justify-center gap-1">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm transition-all ${
                  linkCopied
                    ? "bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 ring-1 ring-green-200 dark:ring-green-800"
          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="bg-linear-to-r from-primary to-secondary px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <p className="text-white font-semibold text-lg">Made with passion</p>
              </div>
              <button
                onClick={() => setShowCreditModal(false)}
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-xl">
                ...
                <div className="flex-1">
                  <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Lead Developer</p>
                  <p className="text-base font-semibold text-gray-800">Fardin Ahmed</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-xl">
                ...
                <div className="flex-1">
                  <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Developer</p>
                  <p className="text-base font-semibold text-gray-800">Eshrak G</p>
                </div>
              </div>
